---
title: 数值分析笔记
date: 2020-09-19T15:30:00-05:00
draft: false
slug: 47adeaf4
author: "miralem"
summary: 这学期选了一个数值分析。说老实话，是实在找不到特别有意思的课，稍微有点凑学分拔将军的意味。不过这课教的知识的确非常有用，所以最好还是写一下笔记，以备以后不时之需。这课用的教材是heath的scientific computing。这笔记基本上就是抄书。
