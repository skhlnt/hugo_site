---
title: 被迫对博客做些改动
date: 2022-05-06T17:33:27-05:00
draft: false
slug: 9f9e01af
author: "miralem"
summary: 前两天，我出于某种原因升级了本地的node.js。然后我就发现我的博客没法用了，网址打开是一片乱码。经过查询确认，我发现原来是因为hexo不支持高版本的node.js。当时我就折腾了半天版本上的事情。并且升级完之后，还不得不使用新版的next主题。新版主题不支持valine评论系统，所以我不久之前好不容易搞明白的评论系统就又没用了。经此一事，我觉得或许有必要对于自己的网站有更深的理解。
